        ...
        return (
            <div className="user_edit">
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" value={this.state.newName} placeholder=" new name" onChange={this.handleChange} id="newName" />
                    <input type="checkbox" value=" delete dp" onChange={this.handleChange} id="deleteDp" />
                    <textarea value={this.state.newBio} onChange={this.handleChange} id="newBio"></textarea>
